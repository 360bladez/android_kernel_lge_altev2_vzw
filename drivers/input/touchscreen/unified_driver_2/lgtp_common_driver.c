...
#if !defined ( TOUCH_MODEL_YG ) && !defined ( TOUCH_MODEL_C100N ) && !defined ( TOUCH_MODEL_M216N )
						if (lockscreen_stat){
...
#if !defined ( TOUCH_MODEL_C70 ) && !defined ( TOUCH_MODEL_C90NAS ) && !defined ( TOUCH_MODEL_P1B ) && !defined ( TOUCH_MODEL_P1C ) && !defined ( TOUCH_MODEL_YG ) && !defined ( TOUCH_MODEL_C100N ) && !defined ( TOUCH_MODEL_M216N )/* TBD : temporally block ( C70 is not ready ) */
