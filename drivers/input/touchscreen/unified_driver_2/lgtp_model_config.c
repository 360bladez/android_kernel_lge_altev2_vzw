...
void TouchGetModelConfig(TouchDriverData *pDriverData)
{
	...
	#elif defined ( TOUCH_MODEL_C70 ) || defined ( TOUCH_MODEL_C90 ) || defined ( TOUCH_MODEL_Y90 ) || defined ( TOUCH_MODEL_Y70 ) || defined ( TOUCH_MODEL_C90NAS) || defined ( TOUCH_MODEL_P1C) || defined ( TOUCH_MODEL_YG ) || defined ( TOUCH_MODEL_C100N ) || defined ( TOUCH_MODEL_M216N )
...
void TouchAssertResetModel( void )
{
	...
	#elif defined ( TOUCH_MODEL_C70 ) || defined ( TOUCH_MODEL_C90NAS) || defined( TOUCH_MODEL_P1B ) || defined ( TOUCH_MODEL_P1C) || defined ( TOUCH_MODEL_YG ) || defined ( TOUCH_MODEL_C100N ) || defined ( TOUCH_MODEL_M216N )
